...
//        NSArray *topLevelObjects = [[NSBundle mainBundle] loadNibNamed:@"JMCIssuePreviewCell" owner:self options:nil];
        NSArray *topLevelObjects = [[JMC frameworkBundle] loadNibNamed:@"JMCIssuePreviewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (sentStatus != JMCSentStatusSuccess) {
        ...
        JMCIssueViewController *detailViewController = [[JMCIssueViewController alloc] initWithNibName:@"JMCIssueViewController" bundle:[JMC frameworkBundle]];
