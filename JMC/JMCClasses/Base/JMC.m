...
{
    return [[JMCViewController alloc] initWithNibName:@"JMCViewController" bundle:[JMC frameworkBundle]];
}
...
//    return [UIImage imageNamed:@"megaphone.png"];
    ...
    return CREATE_IMAGE(@"megaphone.png");
}
...
static NSString * frameworkBundlePath = nil;
+ (NSBundle *)frameworkBundle {
    static NSBundle* frameworkBundle = nil;
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        NSString* mainBundlePath = [[NSBundle mainBundle] resourcePath];
        frameworkBundlePath = [mainBundlePath stringByAppendingPathComponent:JMC_BUNDLE_NAME];
